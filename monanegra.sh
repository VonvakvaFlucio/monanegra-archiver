...
show_help() {
    echo "monanegra.sh Archiver - Created by  Vonvakva Flucio"
    echo "==============================================="
    echo "Usage: ./monanegra.sh \"<search term>\" <DATE_YYYYMMDD> <Quantity>"
    echo ""
    echo "Arguments:"
    ...
    echo ""
    echo "Example:"
    echo "  ./monanegra.sh \"lollapalooza 2018\" 20181231 5"
...
if [ -z "$1" ] || [ -z "$2" ] || [ -z "$3" ]; then
    ...
    echo "correct usage: ./monanegra.sh \"<search term>\" <DATE_YYYYMMDD> <quantity>"
    echo "use ./monanegra.sh --help to further details"
    exit 1
fi
